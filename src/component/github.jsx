...
export default function Github() {
  ...
  return (
    <section id='github' className={style.gitSection_MainDiv} style={{backgroundColor:theme==='Light'?'rgb(234, 244, 255)':'rgb(15,15,15)'}}>
      ...
      <div>
        <div>
          {theme==='Light'?<img id="github-streak-stats" src="https://github-readme-streak-stats.herokuapp.com/?user=karanjarwal999&theme=flag-india&" alt="karanjarwal999" />:
        ...
        <div className="react-activity-calendar" style={{color:theme==='Light'?'Black':'white',backgroundColor:theme==='Light'?'white':'black',border:theme==='Light'?'1px solid lightgray':'1px solid white'}}>
        <GitHubCalendar  username="karanjarwal999"  />
        </div>
        <div>
          {theme==='Light'?<img id="github-stats-card" src="https://github-readme-stats.vercel.app/api?username=karanjarwal999&theme=flag-india&show_icons=true&locale=en" alt="karanjarwal999" />:
        ...
        <div>
          {theme==='Light'?<img  id="github-top-langs" src="https://github-readme-stats.vercel.app/api/top-langs?username=karanjarwal999&theme=flag-india&show_icons=true&locale=en&layout=compact" alt="karanjarwal999" />:
