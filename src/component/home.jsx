...
import TsParticles from "./TsParticle";
...
export default function Home() {
  ...
  return (
    <section
      id="home"
      className={style.home_main_div}
      style={{
        backgroundColor:
          theme === "Light" ? "rgb(234, 244, 255)" : "rgb(10,10,10)",
      ...
      <div>
        <div className={style.homeDiv}>
          <div className={style.basic_info}>
            <p>
              {" "}
              Hii <p className={style.hiiEmoji}>👋</p>, I'm{" "}
            </p>
            <h1 id="user-detail-name">
              <Pulse>Karan Jarwal</Pulse>
            </h1>
